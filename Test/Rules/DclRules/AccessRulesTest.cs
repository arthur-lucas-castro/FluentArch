...
namespace Test.Rules.DclRules
{
    public class AccessRulesTest
    {
        ...
        public void AccessRules_AccessOnlyTargetClass_RuleIsNotValid()
        {
            ...
            Assert.True(!result.IsSuccessful && result._violacoes.First().ClassName.Equals("ClassSource") && result._violacoes.First().Violations.First().Namespace.Equals(namespaceThatClasseSourceAccess));
            #endregion
        }
